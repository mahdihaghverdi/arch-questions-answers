...
\subsection{افزودن \lr{NOOP} بدون وجود \lr{Full For\texttt{WAR}ding}}
\subsection{افزون \lr{NOOP} با وجود \lr{Full For\texttt{WAR}ding}}
...
\section{ارتباط بین \lr{For\texttt{WAR}ding}، \lr{Hazard} و \lr{ISA Desing}}
\end{document}